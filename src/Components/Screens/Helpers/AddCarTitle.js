...
import { View, Image, StyleSheet, Text, TouchableOpacity, TextInput, Platform, ScrollView, Keyboard, StatusBar, Dimensions } from 'react-native';
...
class AddCarTitle extends React.Component {
                    ...
                    <View style={mainContainer}>
                        <View style={imageContainer}>
                            <Image
                                ...
                                source={require('../../../Assets/AddCarLogos/name.jpg')} />
                        </View>
                        <View style={textContainer}>
                            ...
                            <Text>
                                Tell us your car name. This will be the first thing any user will see when they see your ad.
                    </Text>
                            <TextInput
                                value={value}
