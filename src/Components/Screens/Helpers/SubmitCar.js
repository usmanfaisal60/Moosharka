                    ...
                    <View style={mainContainer}>
                        <View style={imageContainer}>
                            <Image
                                ...
                                source={require('../../../Assets/AddCarLogos/submitCar.jpg')} />
                        </View>
                        <View style={textContainer}>
                            ...
                            <Text>
                                Make sure that you have included all the correct information about your car. You shall recieve an email regrading your car being registered to our platform
                            </Text>
                        </View>
                        <View style={buttonsContainer}>
                            ...
                            <TouchableOpacity
                                ...
                                <Image
                                    resizeMode='cover'
                                    style={{ width: '50%', height: '50%' }}
                                    source={require('../../../Assets/AddCarLogos/ok.png')} />
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
