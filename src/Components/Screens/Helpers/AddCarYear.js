...
import { View, Image, StyleSheet, Text, TouchableOpacity, TextInput, StatusBar, Platform, ScrollView, Dimensions, Keyboard } from 'react-native';
...
class AddCarYear extends React.Component {
                    ...
                    <View style={mainContainer}>
                        <View style={imageContainer}>
                            <Image
                                ...
                                source={require('../../../Assets/AddCarLogos/year.jpg')} />
                        </View>
                        <View style={textContainer}>
                            ...
                            <Text>
                                Users need to know your car manufacturing year to make a better choice
                            </Text>
                            <TextInput
                                value={value}
